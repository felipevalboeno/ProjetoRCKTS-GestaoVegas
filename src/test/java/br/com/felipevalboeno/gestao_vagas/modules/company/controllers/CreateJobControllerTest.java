...
import br.com.felipevalboeno.gestao_vagas.utils.TestUtils;
...
public class CreateJobControllerTest {
    ...
    public void should_be_able_to_create_a_new_job() throws Exception {
        ...
        // saveandflush salva a informação antes de terminar toda a requisição
        ...
        var result = mvc.perform(
                MockMvcRequestBuilders.post("/company/job/")
                        ...
                        .header("Authorization",
                                TestUtils.generateToken(company.getId(), "JAVAGAS@123")))
    ...
    public void should_not_be_able_to_create_a_new_job_if_company_does_not_exist() throws Exception {
        ...
        mvc.perform(
                    MockMvcRequestBuilders.post("/company/job/")
                            ...
                            .content(TestUtils.objectToJSON(createJobDTO))
                            .header("Authorization",
                                    TestUtils.generateToken(UUID.randomUUID(), "JAVAGAS@123")))
